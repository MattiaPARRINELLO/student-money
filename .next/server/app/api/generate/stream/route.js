(()=>{var a={};a.id=454,a.ids=[454],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3421:(a,b,c)=>{"use strict";Object.defineProperty(b,"I",{enumerable:!0,get:function(){return g}});let d=c(71237),e=c(55088),f=c(17679);async function g(a,b,c,g){if((0,d.isNodeNextResponse)(b)){var h;b.statusCode=c.status,b.statusMessage=c.statusText;let d=["set-cookie","www-authenticate","proxy-authenticate","vary"];null==(h=c.headers)||h.forEach((a,c)=>{if("x-middleware-set-cookie"!==c.toLowerCase())if("set-cookie"===c.toLowerCase())for(let d of(0,f.splitCookiesString)(a))b.appendHeader(c,d);else{let e=void 0!==b.getHeader(c);(d.includes(c.toLowerCase())||!e)&&b.appendHeader(c,a)}});let{originalResponse:i}=b;c.body&&"HEAD"!==a.method?await (0,e.pipeToNodeResponse)(c.body,i,g):i.end()}}},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},26043:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>C,patchFetch:()=>B,routeModule:()=>x,serverHooks:()=>A,workAsyncStorage:()=>y,workUnitAsyncStorage:()=>z});var d={};c.r(d),c.d(d,{POST:()=>w});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(29554);let v=`Tu es un journaliste expert en finances \xe9tudiantes francophones.
...
- R\xe9ponds UNIQUEMENT avec le contenu MDX, pas de texte avant/apr\xe8s`;async function w(a){let b=new TextEncoder,c=new ReadableStream({async start(c){try{let{topic:d}=await a.json();if(!d||"string"!=typeof d||d.trim().length<3){c.enqueue(b.encode(`event: error
data: ${JSON.stringify({error:"Le sujet doit contenir au moins 3 caract\xe8res."})}

`)),c.close();return}let e=d.trim(),f=process.env.OPENSCODE_API_KEY;if(!f){c.enqueue(b.encode(`event: error
data: ${JSON.stringify({error:"Cl\xe9 API OpenCode non configur\xe9e."})}

`)),c.close();return}c.enqueue(b.encode(`event: status
data: ${JSON.stringify({phase:"search",message:"Recherche d'informations sur le web..."})}

`));let g=Date.now(),h=[e,`${e} \xe9tudiants France 2026`,`${e} aides astuces conseils`],{results:i,urls:j}=await (0,u.O)(h),k=Date.now()-g,l=i.split("[").filter(a=>a.match(/^\d+\]/)).length+i.split("---").length;c.enqueue(b.encode(`event: search
data: ${JSON.stringify({found:l,duration:k})}

`)),c.enqueue(b.encode(`event: status
data: ${JSON.stringify({phase:"generate",message:"L'IA r\xe9dige l'article..."})}

`));let m=await fetch("https://opencode.ai/zen/go/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${f}`,"Content-Type":"application/json"},body:JSON.stringify({model:"deepseek-v4-pro",messages:[{role:"system",content:v},{role:"user",content:function(a,b,c){let d=new Date().toISOString().split("T")[0],e=`SUJET : ${a}
DATE : ${d}
...
`),e+=`\xc9cris l'article complet en MDX. R\xe9ponds UNIQUEMENT avec le contenu MDX.`}(e,i,j)}],temperature:.7,max_tokens:32e3,stream:!0,stream_options:{include_usage:!0}}),signal:AbortSignal.timeout(36e4)});if(!m.ok){c.enqueue(b.encode(`event: error
data: ${JSON.stringify({error:`Erreur API (${m.status})`})}

`)),c.close();return}let n=m.body?.getReader();if(!n){c.enqueue(b.encode(`event: error
data: ${JSON.stringify({error:"Pas de r\xe9ponse de l'API."})}

`)),c.close();return}let o=new TextDecoder,p="",q="";for(;;){let{done:a,value:d}=await n.read();if(a)break;let e=(p+=o.decode(d,{stream:!0})).split("\n");for(let a of(p=e.pop()||"",e)){if(!a.startsWith("data: "))continue;let d=a.slice(6).trim();if("[DONE]"!==d)try{let a=JSON.parse(d),e=a.choices?.[0]?.delta?.content;e&&(q+=e,c.enqueue(b.encode(`event: content
data: ${JSON.stringify({text:e})}

`)))}catch{}}}q.length<10?c.enqueue(b.encode(`event: error
data: ${JSON.stringify({error:"L'IA n'a pas g\xe9n\xe9r\xe9 assez de contenu. R\xe9essaie."})}

`)):c.enqueue(b.encode(`event: done
data: ${JSON.stringify({content:q,length:q.length})}

`))}catch(d){let a=d instanceof Error?d.message:"Erreur inconnue";c.enqueue(b.encode(`event: error
data: ${JSON.stringify({error:a})}

`))}finally{c.close()}}});return new Response(c,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive"}})}let x=new e.AppRouteRouteModule({definition:{kind:f.RouteKind.APP_ROUTE,page:"/api/generate/stream/route",pathname:"/api/generate/stream",filename:"route",bundlePath:"app/api/generate/stream/route"},distDir:".next",relativeProjectDir:"",resolvedPagePath:"/home/mattia/Documents/Perso/student-money/src/app/api/generate/stream/route.ts",nextConfigOutput:"",userland:d}),{workAsyncStorage:y,workUnitAsyncStorage:z,serverHooks:A}=x;function B(){return(0,g.patchFetch)({workAsyncStorage:y,workUnitAsyncStorage:z})}async function C(a,b,c){var d;let e="/api/generate/stream/route";"/index"===e&&(e="/");let g=await x.prepare(a,b,{srcPage:e,multiZoneDraftMode:!1});if(!g)return b.statusCode=400,b.end("Bad Request"),null==c.waitUntil||c.waitUntil.call(c,Promise.resolve()),null;let{buildId:u,params:v,nextConfig:w,isDraftMode:y,prerenderManifest:z,routerServerContext:A,isOnDemandRevalidate:B,revalidateOnlyGenerated:C,resolvedPathname:D}=g,E=(0,j.normalizeAppPath)(e),F=!!(z.dynamicRoutes[E]||z.routes[D]);if(F&&!y){let a=!!z.routes[D],b=z.dynamicRoutes[E];if(b&&!1===b.fallback&&!a)throw new s.NoFallbackError}let G=null;!F||x.isDev||y||(G="/index"===(G=D)?"/":G);let H=!0===x.isDev||!F,I=F&&!H,J=a.method||"GET",K=(0,i.getTracer)(),L=K.getActiveScopeSpan(),M={params:v,prerenderManifest:z,renderOpts:{experimental:{cacheComponents:!!w.experimental.cacheComponents,authInterrupts:!!w.experimental.authInterrupts},supportsDynamicResponse:H,incrementalCache:(0,h.getRequestMeta)(a,"incrementalCache"),cacheLifeProfiles:null==(d=w.experimental)?void 0:d.cacheLife,isRevalidate:I,waitUntil:c.waitUntil,onClose:a=>{b.on("close",a)},onAfterTaskError:void 0,onInstrumentationRequestError:(b,c,d)=>x.onRequestError(a,b,d,A)},sharedContext:{buildId:u}},N=new k.NodeNextRequest(a),O=new k.NodeNextResponse(b),P=l.NextRequestAdapter.fromNodeNextRequest(N,(0,l.signalFromNodeResponse)(b));try{let d=async c=>x.handle(P,M).finally(()=>{if(!c)return;c.setAttributes({"http.status_code":b.statusCode,"next.rsc":!1});let d=K.getRootSpanAttributes();if(!d)return;if(d.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${d.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let e=d.get("next.route");if(e){let a=`${J} ${e}`;c.setAttributes({"next.route":e,"http.route":e,"next.span_name":a}),c.updateName(a)}else c.updateName(`${J} ${a.url}`)}),g=async g=>{var i,j;let k=async({previousCacheEntry:f})=>{try{if(!(0,h.getRequestMeta)(a,"minimalMode")&&B&&C&&!f)return b.statusCode=404,b.setHeader("x-nextjs-cache","REVALIDATED"),b.end("This page could not be found"),null;let e=await d(g);a.fetchMetrics=M.renderOpts.fetchMetrics;let i=M.renderOpts.pendingWaitUntil;i&&c.waitUntil&&(c.waitUntil(i),i=void 0);let j=M.renderOpts.collectedTags;if(!F)return await (0,o.I)(N,O,e,M.renderOpts.pendingWaitUntil),null;{let a=await e.blob(),b=(0,p.toNodeOutgoingHttpHeaders)(e.headers);j&&(b[r.NEXT_CACHE_TAGS_HEADER]=j),!b["content-type"]&&a.type&&(b["content-type"]=a.type);let c=void 0!==M.renderOpts.collectedRevalidate&&!(M.renderOpts.collectedRevalidate>=r.INFINITE_CACHE)&&M.renderOpts.collectedRevalidate,d=void 0===M.renderOpts.collectedExpire||M.renderOpts.collectedExpire>=r.INFINITE_CACHE?void 0:M.renderOpts.collectedExpire;return{value:{kind:t.CachedRouteKind.APP_ROUTE,status:e.status,body:Buffer.from(await a.arrayBuffer()),headers:b},cacheControl:{revalidate:c,expire:d}}}}catch(b){throw(null==f?void 0:f.isStale)&&await x.onRequestError(a,b,{routerKind:"App Router",routePath:e,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:B})},A),b}},l=await x.handleResponse({req:a,nextConfig:w,cacheKey:G,routeKind:f.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:z,isRoutePPREnabled:!1,isOnDemandRevalidate:B,revalidateOnlyGenerated:C,responseGenerator:k,waitUntil:c.waitUntil});if(!F)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==t.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(j=l.value)?void 0:j.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});(0,h.getRequestMeta)(a,"minimalMode")||b.setHeader("x-nextjs-cache",B?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),y&&b.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,p.fromNodeOutgoingHttpHeaders)(l.value.headers);return(0,h.getRequestMeta)(a,"minimalMode")&&F||m.delete(r.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||b.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,q.getCacheControlHeader)(l.cacheControl)),await (0,o.I)(N,O,new Response(l.value.body,{headers:m,status:l.value.status||200})),null};L?await g(L):await K.withPropagatedContext(a.headers,()=>K.trace(m.BaseServerSpan.handleRequest,{spanName:`${J} ${a.url}`,kind:i.SpanKind.SERVER,attributes:{"http.method":J,"http.target":a.url}},g))}catch(b){if(b instanceof s.NoFallbackError||await x.onRequestError(a,b,{routerKind:"App Router",routePath:E,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:B})}),F)throw b;return await (0,o.I)(N,O,new Response(null,{status:500})),null}}},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},29554:(a,b,c)=>{"use strict";function d(a){return a.replace(/<[^>]*>/g,"").trim()}async function e(a){try{let b=encodeURIComponent(a+" France"),c=`https://news.google.com/rss/search?q=${b}&hl=fr&gl=FR&hl=fr`,e=await fetch(c,{headers:{"User-Agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36"},signal:AbortSignal.timeout(8e3)});if(!e.ok)return{results:"",urls:"",count:0};let f=(await e.text()).match(/<item>[\s\S]*?<\/item>/gi)||[],g=[],h=[];for(let a of f.slice(0,5)){let b=d(a.match(/<title>([\s\S]*?)<\/title>/)?.[1]||""),c=(a.match(/<link>([\s\S]*?)<\/link>/)?.[1]||"").trim(),e=a.match(/<pubDate>([\s\S]*?)<\/pubDate>/)?.[1]||"",f=a.match(/<description>([\s\S]*?)<\/description>/)?.[1]||"",i=d(d(f)),j=d(a.match(/<source[^>]*>([\s\S]*?)<\/source>/)?.[1]||"");if(b&&c){let a=e?new Date(e).toLocaleDateString("fr-FR"):"";g.push(`Titre: ${b}
